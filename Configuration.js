...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var accelerationx = endpoints.addEndpoint("2", "Acceleration X", endpointType.genericSensor);
    accelerationx.variableTypeId = 1282;
    var accelerationy = endpoints.addEndpoint("3", "Acceleration Y", endpointType.genericSensor);
    accelerationy.variableTypeId = 1282;
    var accelerationz = endpoints.addEndpoint("4", "Acceleration Z", endpointType.genericSensor);
    accelerationz.variableTypeId = 1282;
    var velocityx = endpoints.addEndpoint("5", "Velocity X", endpointType.genericSensor);
    velocityx.variableTypeId = 1281;
    var velocityy = endpoints.addEndpoint("6", "Velocity Y", endpointType.genericSensor);
    velocityy.variableTypeId = 1281;
    var velocityz = endpoints.addEndpoint("7", "Velocity Z", endpointType.genericSensor);
    velocityz.variableTypeId = 1281;
    endpoints.addEndpoint("8", "Temperature sensor", endpointType.temperatureSensor);
  }
